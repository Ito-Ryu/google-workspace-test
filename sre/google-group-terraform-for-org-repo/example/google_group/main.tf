locals {
  ...
  module_base_url = "git::https://github.com/your-org/terraform-google-group-for-org-repo.git//modules"
...
module "organizational_groups" {
  source = "${local.module_base_url}/organizational-groups?ref=${local.module_version}"
...
module "legacy_groups" {
  source = "${local.module_base_url}/legacy-groups?ref=${local.module_version}"
